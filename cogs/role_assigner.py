    ...
    async def on_message(self, message: discord.Message):
        ...
        if final_roles_to_add:
            try:
                ...
                await message.reply(f"✅ Halo {message.author.mention}, Anda telah menerima role: {role_names}!,  Anda bisa Mendownload Filenya di ⁠🚀┃download dan claim token di ⁠🎫┃claim-token!")
